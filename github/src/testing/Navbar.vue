  ...
  <div>
    ...
    <mt-tabbar v-model="selected" fixed>
      <mt-tab-item id="index">
        首页
        <img src="../assets/index_enabled.png" alt="" slot="icon" v-if="selected == 'index'">
        <img src="../assets/index_disabled.png" alt="" slot="icon" v-else>        
      </mt-tab-item>
      <mt-tab-item id="cart">
        购物车
        <img src="../assets/cart_enabled.png" alt="" slot="icon" v-if="selected == 'cart'">
        <img src="../assets/cart_disabled.png" alt="" slot="icon" v-else> 
      </mt-tab-item>
      <mt-tab-item id="me">
        我的
         <img src="../assets/me_enabled.png" alt="" slot="icon" v-if="selected == 'me'">
